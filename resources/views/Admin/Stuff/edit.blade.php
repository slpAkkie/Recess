        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 bg-white p-6">
                    <form class="create-stuff-form col-12 mx-auto" action="{{ route('admin.stuff.update', $stuff->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input type="text" name="full_name"
                                    ...
                                    value="{{ old('full_name') ?? $stuff->full_name }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input type="text" name="position"
                                    ...
                                    value="{{ old('position') ?? $stuff->position }}">
                                <div class="invalid-feedback text-bold">
                                    @error('position')
                                        {{ $message }}
                                    @enderror
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <textarea name="description" class="form-control border @error('description') is-invalid @enderror" placeholder="Описание"
                                    cols="30" rows="5">{{ old('description') ?? $stuff->description }}</textarea>
                                <div class="invalid-feedback text-bold">
                                    @error('description')
                                        {{ $message }}
                                    @enderror
