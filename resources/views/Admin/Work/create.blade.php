...
<div class="site-section">
    <div class="container">
        <div class="row justify-content-center">
            <form class="login-form col-12" action="{{ route('admin.works.store') }}" method="post">
                @csrf
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        <input type="text" name="country"
                            class="form-control @error('country') is-invalid @enderror" placeholder="Страна"
                            value="{{ old('country') }}">
                        <div class="invalid-feedback text-bold">
                            @error('country')
                                {{ $message }}
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        <input type="text" name="city"
                            class="form-control @error('city') is-invalid @enderror" placeholder="Город"
                            value="{{ old('city') }}">
                        <div class="invalid-feedback text-bold">
                            @error('city')
                                {{ $message }}
