    ...
    <div class="site-section">
        <div class="container">
            <div class="row justify-content-center">
                <h2 class="heading-39291 col-12 text-center">Новая услуга</h2>
                ...
                <form class="login-form col-12" action="{{ route('admin.services.store') }}" method="post">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <input type="text" name="price_per_hour"
                                class="form-control @error('price_per_hour') is-invalid @enderror" placeholder="Цена за час"
